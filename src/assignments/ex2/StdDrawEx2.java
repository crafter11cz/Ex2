...
public final class StdDrawEx2 implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ////////////// Ex2 123456////////////////////
    public static String getCell(assignments.ex2.Index2D cord, String input) {
    ...
    public static void save(String filename) {
        assignments.ex2.Ex2GUI.save(filename);
    }
    public static void load(String filename) {
        assignments.ex2.Ex2GUI.load(filename);
    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        double y = assignments.ex2.Ex2Utils.HEIGHT-my;
        double x = (mx-2)/2;
        xx = (int)x;
        yy=(int)y;
        if(assignments.ex2.Ex2Utils.Debug) {System.out.println("Mouse: "+xx+","+yy);}
